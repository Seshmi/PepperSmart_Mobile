...
const byte centerX = 15;  // X-coordinate of the center pixel
const byte centerY = 11;  // Y-coordinate of the center pixel
...
void loop() {
  while(debug) {
    ...
    float centerPixelTemp = mlx90640To[centerY * 32 + centerX];
    debug.println(centerPixelTemp);
    //  debug.println("");
  }
}
